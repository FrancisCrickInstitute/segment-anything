...
def mask_to_rle_pytorch(tensor: torch.Tensor) -> List[Dict[str, Any]]:
    ...
    # Workaround for INT_MAX issue in torch.nonzero
    # From https://github.com/facebookresearch/segment-anything/pull/569/files

    # First test if more than INT_MAX elements to revert to original if not
